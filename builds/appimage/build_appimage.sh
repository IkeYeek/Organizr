...
mkdir -p "organizr.AppDir"
cp -r ../appimage_deb/data/usr "organizr.AppDir"
...
# We need AppRun to be installed as organizr.AppDir/AppRun.
...
cp "usr/share/icons/hicolor/256x256@2/apps/organizr.png" .DirIcon
ln -sf "usr/share/icons/hicolor/256x256@2/apps/organizr.png" "organizr.png"

ln -sf "usr/share/applications/organizr.desktop" "organizr.desktop"
...
OUTPUT="organizr_0.1.0_amd64.AppImage" "/home/runner/.cache/tauri/linuxdeploy-${linuxdeploy_arch}.AppImage" --appimage-extract-and-run --appdir "organizr.AppDir" --plugin gtk ${gst_plugin} --output appimage
